...
const Hero = () => {
  return (
    <section className='bg-bg h-[90vh] grid grid-cols-1 md:grid-cols-10'>
        <div className="md:col-span-6 flex items-center justify-center text-primary-100">
            <div className="flex flex-col gap-2 text-center">
                <h1 className="text-7xl font-bold">Bienvenidos!</h1>
                <p className="text-4xl">Explora la innovación 3D.</p>
                <p className="text-4xl">Descubre nuestra comunidad.</p>
        ...
        <div className="md:col-span-4 flex items-center justify-center p-12">
            <img src="logo-fondo.png"className="h-40 object-cover"/>
        </div>
    </section>
  )
}
