        ...
        <div id="home" className="h-[90vh] grid grid-cols-1 md:grid-cols-10 xl:max-w-[2400px] l:max-w-[1200px] mx-auto">
            <div className="md:col-span-5 flex items-center justify-center text-primary-100">
                <div className="flex flex-col gap-2 text-center">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                        <a href="https://app.clockify.me/shared/65d87eea756abe0bdf308a40" className="relative flex h-[50px] w-40 rounded-xl items-center justify-center overflow-hidden bg-primary-200 font-medium text-white shadow-2xl transition-all duration-300 before:absolute before:inset-0 before:border-0 before:border-white before:duration-100 before:ease-linear hover:bg-white hover:text-primary-200 hover:shadow-primary-200 hover:before:border-[25px]">
                            <span className="relative z-10">Clockify</span>
                        </a>
                    </div>
                </div>
            </div>
